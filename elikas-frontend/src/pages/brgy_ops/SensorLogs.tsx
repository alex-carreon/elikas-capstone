...
function SensorLogs() {
  ...
  return (
    <div className="w-full max-w-sm flex flex-col gap-4 pt-20 p-5">
      <p className="font-bold text-xl" style={{ color: colors.heading }}>
              ...
              <Fragment key={index}>
                ...
                >
                  <div className="flex flex-row gap-2">
                    ...
                    >
                      {log.statusLevel ? log.statusLevel : "No Level Detected"}
                    </div>
                  </div>
                </Row>
              </Fragment>
